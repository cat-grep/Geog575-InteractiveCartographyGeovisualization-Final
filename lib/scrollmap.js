                ...
                background.childNodes.forEach(function(child){
                    ...
                    if (child.nodeName != "#text" && child.nodeName != "#comment"){
                        ...
                        document.addEventListener("scroll", function () {
                            const containerBottom = scrollContainer.offsetTop + scrollContainer.scrollHeight;
                            let scrollPos = window.scrollY + (window.innerHeight) - foregroundItems[id].clientHeight,
                                ...
                                foreGroundBottom = nextId
                                ? foregroundItems[nextId].offsetParent.offsetTop + foregroundItems[nextId].offsetTop
                                : containerBottom;
                            if (scrollPos > foreGroundOffset && scrollPos < foreGroundBottom) {
                            if (child.classList.contains("hidden")) {
                                if (child.previousElementSibling) child.previousElementSibling.classList.add("hidden");
                                if (child.nextElementSibling) child.nextElementSibling.classList.add("hidden");
